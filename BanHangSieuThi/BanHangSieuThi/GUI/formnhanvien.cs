...
{  
    public partial class formnhanvien : Form
    {
        ...
        {
            string query = "SELECT TenNV 'Họ tên',GT AS 'Giới tính',DiaChi as 'Địa chỉ',SDT AS 'SĐT' FROM dbo.tblNhanVien" +
               " where dbo.tblNhanVien.TenNV like N'%" + gunaTxtTimkiem.Text + "%'" + " OR DiaChi  LIKE N'%" + gunaTxtTimkiem.Text + "%'";
